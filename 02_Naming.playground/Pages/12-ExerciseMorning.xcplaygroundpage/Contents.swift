...
let totalExcercise = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
...
let necessaryExercise = brushTeeth + shower + finishHomework + fixLunch
let wantExercise = uploadPhotos + chooseClothes + goJogging
