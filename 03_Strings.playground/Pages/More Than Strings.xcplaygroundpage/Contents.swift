...
let storyName = "Rishab"
let storyNumber = 10
let storyAdjective = "cool"
let storyNoun = "game"
let storyNoun2 = "radical"
let place = "store"
let positiveEmotion = "happy"
let negativeEmotion = "mad"
let storyNoun3 = "gas"
let coolStory = "Today was a big day for \(storyName). They had finally saved up \(storyNumber) dollars and were going to buy a \(storyAdjective) \(storyNoun). They went to the \(storyNoun2) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(storyNoun3)!"
